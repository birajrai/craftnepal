        ...
        <>
            ...
            <div className="lanternContainner">
                <img
                    ...
                    src={lantern}
                    onClick={() => {
                        document.getElementsByClassName('lanternLight')[0].classList.toggle('lightsON');
                        document.getElementsByClassName('lantern')[0].classList.toggle('lanternDark');
                        document.getElementsByClassName('etableContainner')[0].classList.toggle('darkEtable');
                    }}
                ></img>
